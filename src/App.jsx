...
const LEGENDS_SG = [
  { name: "Fandi Ahmad", shortName: "Fandi Ahmad", era: "1978–1997", lesson: "Singapore's greatest ever player. Scored against Pelé's Santos at 17. Proved that a boy from Kampong Glam can take on the world's best and win.", badge: "🇸🇬", stat: "Singapore's all-time top scorer" },
  { name: "Ikhsan Fandi", shortName: "Ikhsan Fandi", era: "2018–present", lesson: "Following in his father's footsteps — playing professionally in Europe and representing Singapore abroad. The next generation carrying the flag.", badge: "🌏", stat: "First SG player in Norwegian league" },
  { name: "Nazri Nasir", shortName: "Nazri Nasir", era: "1993–2012", lesson: "One of the most consistent defenders in Singapore football. Led by example — calm under pressure, composed in the big moments.", badge: "🛡️", stat: "SEA Games gold medallist" },
  ...
  { name: "Shahril Ishak", shortName: "Shahril Ishak", era: "2002–2019", lesson: "The 'Wizard' — known for his vision, creativity, and clutch performances in big games. Flair and intelligence beat raw size every time.", badge: "🎩", stat: "AFF Suzuki Cup winner" },
  { name: "Indra Sahdan", shortName: "Indra Sahdan", era: "1997–2016", lesson: "Speed demon on the wing. His pace and directness terrorised defences across Southeast Asia. Natural gifts + hard work = something special.", badge: "💨", stat: "AFF Championship winner" },
];
...
function LegendsSection() {
  ...
  return (
    <section style={{ padding: "100px 24px 80px", maxWidth: 900, margin: "0 auto" }}>
      <SectionHeader icon="🌟" title="LEGENDS" subtitle="Lessons from the greatest — from Kampong Glam to the Camp Nou" accent={C.gold} />
