...
const LEGENDS_SG = [
  ...
  { name: "Indra Sahdan", shortName: "Indra Sahdan", era: "1997–2016", lesson: "A true predator. Indra Sahdan was a striker built for the big occasion — razor-sharp movement in behind the defence, ice-cold composure in front of goal, and a finishing ability that made him one of the most feared forwards in the region. His biggest moment of individual brilliance came against Manchester United, when he scored against one of the most famous clubs on the planet — a goal that announced to the world that Singapore had a genuine striker of quality. Clinical, relentless, and always a threat, Indra showed that Singapore could produce forwards who delivered in the moments that mattered most.", badge: "🎯", stat: "Scored vs Manchester United" },];
